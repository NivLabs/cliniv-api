...
import br.com.tl.gdp.service.AttendanceService;
...
public class AttendanceController {
     ...
     * @return
     */
    @ApiOperation(nickname = "attendance-put-exit", value = "Atualiza hora de saída da visita na aplicação")
    @PutMapping("/{id}/status")
    @PreAuthorize("hasAnyRole('ATENDIMENTO_ESCRITA', 'ADMIN')")
    public ResponseEntity<Void> updateAttendanceToEnd(@PathVariable("id") Long id) {
        service.closeAttendance(id);
