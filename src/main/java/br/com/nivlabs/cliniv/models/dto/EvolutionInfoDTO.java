...
public class EvolutionInfoDTO extends DataTransferObjectBase {
    ...
    @Schema(description = "Identificador únimco da evolução clínica")
    private Long id;

    @Schema(description = "Identificador únimco do atendimento (Obrigatório)")
    @NotNull(message = "Informe o código do atendimento")
    private Long attendanceId;

    @Schema(description = "Identificador únimco da acomodação do paciente (Opcional se já houver registro com acomodação)")
    private Long accommodationId;

    @Schema(description = "Descrição da evolução (Obrigatório)")
    @NotNull(message = "Informe a descrição da evolução clínica")
    private String description;

    @Schema(description = "Data/Hora da leitura da evolução")
