...
import br.com.nivlabs.cliniv.integration.RestResponsePage;
...
public class GTISSClient implements RestClient {
    ...
    private static final Logger logger = LoggerFactory.getLogger(GTISSClient.class);
    ...
    private void handleException(HttpStatusCode statusCode, String parameter) {
