...
import br.com.nivlabs.cliniv.integration.gtiss.Fee;
import br.com.nivlabs.cliniv.integration.gtiss.GTISSClient;
import br.com.nivlabs.cliniv.integration.gtiss.Material;
import br.com.nivlabs.cliniv.integration.gtiss.MedicalProcedure;
import br.com.nivlabs.cliniv.integration.gtiss.Medicine;
import br.com.nivlabs.cliniv.models.dto.FeeDTO;
import br.com.nivlabs.cliniv.models.dto.MaterialDTO;
import br.com.nivlabs.cliniv.models.dto.MedicalProcedureDTO;
...
public class GTISSService {
    ...
    private FeeDTO getFeeDTO(Fee fee) {
        ...
        feeDTO.setStartOfTerm(StringUtils.convertStringToDate(fee.getExpirationStartDate()));
        feeDTO.setEndOfTerm(StringUtils.convertStringToDate(fee.getExpirationDate()));
        feeDTO.setEndOfImplantationDate(StringUtils.convertStringToDate(fee.getExpirationDate()));
        return feeDTO;
    }
}
