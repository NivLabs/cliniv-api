...
public class AnamneseController {
	...
	@ApiOperation(nickname = "responsible-post", value = "Insere uma nova anamnese na aplicação")
	@PostMapping
	...
	@ApiOperation(nickname = "responsible-put", value = "Atualiza uma anamnese na aplicação")
	@PutMapping("/{id}")
